...
public class VncViewer extends JPanel {
...
//  public VncViewer(int port, String host) {
//	  this.port= port;
//	  this.host = host;
//  }

    public VncViewer(int port, String host, ButtonPanel.BackEventListenr listener){
        init(port, host, listener, null);
    }

    public VncViewer(int port, String host, ButtonPanel.BackEventListenr listener, Frame frame) {
        init(port, host, listener, frame);
    }

    public void init(int port ,String host, ButtonPanel.BackEventListenr listener, Frame frame) {
...
/*
        ...
        */
        ...
        vncContainer.setSize(480, 272+23);
        recordingSync = new Object();
        options = new OptionsFrame(this);
        buttonPanel = new ButtonPanel(this, listener);
...
//      vncFrame.addWindowListener(this);
        ...
        rfbThread = new Thread(new ThreadRun());
        rfbThread.start();
    }
...
//	      if (showControls)
                ...
                buttonPanel.setBorder(BorderFactory.createLineBorder(Color.darkGray, 1));
                System.out.println("screen.size"+ vncContainer.getToolkit().getScreenSize());
                System.out.println("VncViewer.size:"+ vncContainer.getSize());
                ...
                fatalError("连接失败: no route to server: " + host, e);
            } catch (UnknownHostException e) {
                fatalError("连接失败: server name unknown: " + host, e);
            } catch (ConnectException e) {
                fatalError("连接失败: 不能连接到: " +host + ":" + port, e);
...
//      }
    ...
    void doProtocolInitialisation() throws IOException
    {
        ...
        vncContainer.setSize(rfb.framebufferWidth, rfb.framebufferHeight+23);
        setEncodings();
