...
class ButtonPanel extends JPanel implements ActionListener {
  ...
  private BackEventListenr mBackEventListenr = null;

  ButtonPanel(VncViewer v, BackEventListenr listenr) {
    viewer = v;
    mBackEventListenr = listenr;
...
//    }
    ...
    //ip Text
    Label ipText = new Label("  IP: " + viewer.host);
    add(ipText);
...
//      viewer.clipboard.setVisible(!viewer.clipboard.isVisible());
	...
	rfb.writeFramebufferUpdateRequest(0, 0, rfb.framebufferWidth,
        ...
        viewer.disconnect();
    	if(mBackEventListenr != null){
    		mBackEventListenr.OnBackEvent();
    	}
    }
  }
  
  public interface BackEventListenr{
