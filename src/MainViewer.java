...
public class MainViewer  extends  Applet implements WindowListener{
    ...
    public static void main(String[] argv) {
        ...
        JFrame frame = new JFrame("显控监控软件 "+VERSION);
    ...
    private class UIRefresh implements Observer {

        @Override
        public void update(Observable o, Object arg) {
            System.out.println("get onRefreshed!!!");
            mFrame.pack();
        }
    }
    ...
    private void VNCshow(){
        ...
        if (mainFrame == null) {
            ...
            //mainFrame.setBorder(BorderFactory.createLineBorder(Color.gray, 4));
            mainFrame.setBackground(new Color(173, 216, 230));
        }
        ...
        if(selectList.size() <4 ){
            ...
            for (int i = 0; i < selectList.size(); i++) {
                ...
                v.addRefreshObserver(new UIRefresh());
                v.setBorder(BorderFactory.createLineBorder(Color.black, 3));
                mainFrame.add(v);
            }

            CardLayout cLayout = new CardLayout();
            vncContainer.setLayout(cLayout); //maybe no need layout!!!!MQ
            //vncContainer.setSize(screenSize);
//            vncContainer.setMaximumSize(screenSize);
//            vncContainer.setMinimumSize(screenSize);
//            vncContainer.setPreferredSize(screenSize);
